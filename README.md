...
| [Greedy Algorithms](greedy/README.md) | Locally optimal choice provably leads to a global optimum | 7 |
| [Sliding Window](sliding-window/README.md) | Expand/shrink a contiguous window over an array or string | 7 |
| [Two Pointers](two-pointers/README.md) | Converging or fast/slow pointers, usually over sorted data | 7 |
| [Binary Search](binary-search/README.md) | Halve the search space using a monotonic condition | 7 |
| [Heap / Priority Queue](heap-priority-queue/README.md) | Efficient access to the min/max of a dynamic set | 7 |
| [Union-Find (Disjoint Set Union)](union-find/README.md) | Track and merge connected components efficiently | 7 |
